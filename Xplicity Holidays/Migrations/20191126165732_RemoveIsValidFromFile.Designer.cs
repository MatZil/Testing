...
namespace Xplicity_Holidays.Migrations
{
    ...
    [Migration("20191126165732_RemoveIsValidFromFile")]
    partial class RemoveIsValidFromFile
    {
            ...
            modelBuilder.Entity("Xplicity_Holidays.Infrastructure.Database.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthdayDate = new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Local),
                            ...
                            Status = 1,
                            Surname = "Admin",
                            WorksFromDate = new DateTime(2019, 11, 26, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });

            modelBuilder.Entity("Xplicity_Holidays.Infrastructure.Database.Models.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
